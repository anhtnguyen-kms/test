import { t as E, M as O, C as $, l as a, b as d, m as Q, r as L, n as S, e as l, O as j, A, o as f, x as v, q as ee, u as M, w as q, y as V, T as z, z as H, B as te, D as ie, E as oe, F as ne, G as se, H as re, I as ae } from "./copilot-DR4GJi6q.js";
import { n as R, r as W } from "./state-CQhJRysS.js";
import { e as y, m as G } from "./overlay-monkeypatch-u7yqzQJY.js";
import { i as u } from "./icons-A-UqNqgU.js";
import { o as le, p as ce } from "./react-utils-D_MlSXfo.js";
import { dismissNotification as de, showNotification as he } from "./copilot-notification-4pK4Jqft.js";
/**
 * @license
...
var pe = Object.defineProperty, ue = Object.getOwnPropertyDescriptor, x = (e, t, o, n) => {
  for (var i = n > 1 ? void 0 : n ? ue(t, o) : t, r = e.length - 1, s; r >= 0; r--)
...
let b = class extends O {
  constructor() {
    super(...arguments), this.position = "right", this.opened = !1, this.keepOpen = !1, this.resizing = !1, this.closingForcefully = !1, this.draggingSectionPanel = null, this.activationAnimationTransitionEndListener = () => {
      ...
      const e = this.getAllPanels().filter(
        (t) => t.hasAttribute(D) && t.panelInfo?.panelOrder !== Number.parseInt(t.getAttribute(D), 10)
      ).map((t) => ({
        tag: t.panelTag,
        order: Number.parseInt(t.getAttribute(D), 10)
      }));
      ...
      this.getAllPanels().sort((t, o) => {
        ...
        if (t.setAttribute(D, `${o}`), t.panelTag !== this.draggingSectionPanel?.panelTag) {
  ...
  connectedCallback() {
    ...
    const e = $.getDrawerSize(this.position);
  ...
  cleanUpDragging() {
    this.draggingSectionPanel && (l.setSectionPanelDragging(!1), this.draggingSectionPanel.style.zIndex = "", Array.from(this.querySelectorAll("copilot-section-panel-wrapper")).forEach((e) => {
      e.style.removeProperty("transform"), e.removeAttribute(D), e.removeAttribute(B);
...
b = x([
  E("copilot-drawer-panel")
], b);
var ve = Object.defineProperty, fe = Object.getOwnPropertyDescriptor, Z = (e, t, o, n) => {
  for (var i = n > 1 ? void 0 : n ? fe(t, o) : t, r = e.length - 1, s; r >= 0; r--)
    (s = e[r]) && (i = (n ? s(t, o, i) : s(i)) || i);
...
const m = new be();
var we = Object.defineProperty, ye = Object.getOwnPropertyDescriptor, U = (e, t, o, n) => {
  for (var i = n > 1 ? void 0 : n ? ye(t, o) : t, r = e.length - 1, s; r >= 0; r--)
    (s = e[r]) && (i = (n ? s(t, o, i) : s(i)) || i);
  ...
  constructor() {
    super(...arguments), this.initialMouseDownPosition = null, this.dragging = !1, this.mouseDownListener = (e) => {
      ...
      if (this.initialMouseDownPosition && !this.dragging) {
        const { clientX: t, clientY: o } = e;
        this.dragging = Math.abs(t - this.initialMouseDownPosition.x) + Math.abs(o - this.initialMouseDownPosition.y) > xe;
      }
...
T = U([
  E("copilot-activation-button")
], T);
var Pe = Object.defineProperty, ze = Object.getOwnPropertyDescriptor, I = (e, t, o, n) => {
  for (var i = n > 1 ? void 0 : n ? ze(t, o) : t, r = e.length - 1, s; r >= 0; r--)
    (s = e[r]) && (i = (n ? s(t, o, i) : s(i)) || i);
  return n && i && Pe(t, o, i), i;
};
...
let w = class extends O {
  constructor() {
    super(...arguments), this.panelTag = "", this.dockingItems = [
      ...
      this.hasAttribute(_) && e.button === 0 && (e.stopPropagation(), e.preventDefault(), m.anchorLeftTop(this), this.floatingResizingStarted = !0, this.toggleAttribute("resizing", !0), q(() => {
      ...
      if (!this.floatingResizingStarted || !this.panelInfo?.floating)
        return;
      e.stopPropagation(), e.preventDefault(), this.floatingResizingStarted = !1, q(() => {
...
w = I([
  E("copilot-section-panel-wrapper")
], w);
d.on("undoRedo", (e) => {
  const o = { files: e.detail.files ?? le(), uiId: ce() }, n = e.detail.undo ? "copilot-plugin-undo" : "copilot-plugin-redo";
  d.send(n, o);
});
var Ae = Object.defineProperty, Ie = Object.getOwnPropertyDescriptor, ke = (e, t, o, n) => {
  for (var i = n > 1 ? void 0 : n ? Ie(t, o) : t, r = e.length - 1, s; r >= 0; r--)
    (s = e[r]) && (i = (n ? s(t, o, i) : s(i)) || i);
  return n && i && Ae(t, o, i), i;
};
...
Y = ke([
  E("copilot-notifications-container")
], Y);
function Ce(e) {
