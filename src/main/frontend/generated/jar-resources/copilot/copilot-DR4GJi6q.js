...
const Re = "copilot-", ts = "24.4.20", Dl = "attention-required", Cl = "https://plugins.jetbrains.com/plugin/23758-vaadin", Tl = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode", Vl = (e, t, r) => t >= e.left && t <= e.right && r >= e.top && r <= e.bottom, rs = (e) => {
  const t = [];
  let r = is(e);
  for (; r; )
...
function Vs() {
  ve.push(import("./copilot-log-plugin-DvFbb2Y3.js")), ve.push(import("./copilot-info-plugin-n10qU7wO.js")), ve.push(import("./copilot-features-plugin-C0UDQAO6.js")), ve.push(import("./copilot-feedback-plugin-D2BPcbA-.js")), ve.push(import("./copilot-shortcuts-plugin-CzxmPv7R.js"));
}
function js() {
  {
...
const Ls = Wi(Or);
function Xi() {
  return import("./copilot-notification-4pK4Jqft.js");
}
const Ms = (e) => {
...
let xn = class extends Ts {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, document.body.style.setProperty("--dev-tools-button-display", "none"), await import("./copilot-global-vars-later-CW_dVd9b.js"), await import("./copilot-init-step2-D_8bCOYo.js"), Vs(), this.tabIndex = 0, Ot.hostConnectedCallback(), window.addEventListener("keydown", wn), x.onSend(this.handleSendEvent), this.removers.push(x.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
